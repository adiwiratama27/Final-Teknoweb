            ...
            @auth
                @if (Auth::user()->role == 'user')
                    <div class="w-full overflow-x-hidden border-t flex flex-col">
                        <!-- Desktop Header -->
                        <header class="w-full items-center py-2 px-6 hidden sm:flex bg-gradient-to-r from-red-900 via-red-400 to-red-900">
                            <div class="w-1/2"></div>
                ...
                @else
                <aside class="relative bg-red-900 h-screen w-64 hidden sm:block shadow-xl">
                    {{-- <div class="p-6">
                    ...
                    <div class="w-44">
                        <img src="gambar4.jpg" alt="Depo Anyar Bangunan">
                    </div>
